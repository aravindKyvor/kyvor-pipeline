...
const TNProjectForm = () => {
  ...
  const [biosample_n_file1, setbiosample_n_file1] = useState("");
  const [biosample_n_file2, setbiosample_n_file2] = useState("");
  const [biosample_t_file3, setbiosample_t_file3] = useState("");
  const [biosample_t_file4, setbiosample_t_file4] = useState("");
  ...
  const addPostRequest = async (e) => {
    ...
    setTimeout(function () {
      window.location.href = `${process.env.REACT_APP_API_URL}/basespace/projects/list`;
    ...
    formField.append("biosample_n_file1", biosample_n_file1);
    formField.append("biosample_n_file2", biosample_n_file2);
    formField.append("biosample_t_file3", biosample_t_file3);
    formField.append("biosample_t_file4", biosample_t_file4);

    await axios({
      method: "post",
      url: `${process.env.REACT_APP_API_URL}/api/pipeline-tn`,
      headers: {
            ...
            <div className=" col-11 grid-margin stretch-card-1 ">
              <div className="card">
                <div className="card-body">
                  ...
                  <Form.Group>
                    <label id="biosample_t_file1">biosample_n_file1</label>
                    <Form.Control
                      type="file"
                      placeholder="BioSample Path"
                      onChange={(e) => setbiosample_n_file1(e.target.files[0])}
                      required
                    />
                  </Form.Group>
                  <Progress percentage={uploadPercentage} />
                  <Form.Group>
                    <label id="biosample_t_file2">biosample_n_file2</label>
                    <Form.Control
                      type="file"
                      placeholder="BioSample Path"
                      onChange={(e) => setbiosample_n_file2(e.target.files[0])}
                      required
                    />
                  </Form.Group>
                  <Progress percentage={uploadPercentage} />
                  <Form.Group>
                    ...
                    <Form.Control
                      type="file"
                      placeholder="BioSample Path"
                      onChange={(e) => setbiosample_t_file3(e.target.files[0])}
                    />
                  </Form.Group>
                  <Progress percentage={uploadPercentage} />
                  <Form.Group>
                    ...
                    <Form.Control
                      type="file"
                      placeholder="BioSample Path"
                      onChange={(e) => setbiosample_t_file4(e.target.files[0])}
                    />
                  </Form.Group>
                  <Progress percentage={uploadPercentage} />
