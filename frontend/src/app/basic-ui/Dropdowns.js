            ...
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-description">
                  Add class <code>.btn-gradient-&#123;color&#125;</code> to the
                ...
                <div className="template-demo">
                  ...
                  <Dropdown>
                    <Dropdown.Toggle
                      variant="btn btn-gradient-secondary"
                  ...
                  <Dropdown>
                    <Dropdown.Toggle
                      variant="btn btn-gradient-danger"
                  ...
                  <Dropdown>
                    <Dropdown.Toggle
                      variant="btn btn-gradient-warning"
                  ...
                  <Dropdown>
                    <Dropdown.Toggle
                      variant="btn btn-gradient-success"
